...
setTimeout(() => {
  if (allow) {
    ...
    console.log("Wellcome to the beta version of the website!, if you find any bugs please report them to the developer, this project will be released the" + endDate);
  } else {
    document.body.style.display = "none";
